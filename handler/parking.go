...
func (h *ParkingHandler) RegisterCard(w http.ResponseWriter, r *http.Request) {
...
func (h *ParkingHandler) RenewCard(w http.ResponseWriter, r *http.Request) {
...
func (h *ParkingHandler) GetCard(w http.ResponseWriter, r *http.Request) {
